...
const Banner = () => {
    return (
        ...
        >
            ...
            <SwiperSlide>
                <section className="relative bg-cover bg-center bg-no-repeat md:h-[100vh] h-[500px]" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(${slider1})` }}>

                    <div className="absolute inset-0 sm:bg-transparent  sm:to-white/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l">
                    </div>
            ...
            <SwiperSlide>
                <section className="relative bg-cover bg-fixed bg-center bg-no-repeat md:h-[100vh] h-[500px]" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(${slider3})` }}>
            ...
            <SwiperSlide>
                <section className="relative bg-cover bg-fixed bg-center bg-no-repeat md:h-[100vh] h-[500px]" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(${slider4})` }}>
