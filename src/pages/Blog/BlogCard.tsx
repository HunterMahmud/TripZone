...
const BlogCard: React.FC<{ item: ItemProps }> = ({ item }) => {
    return (
        <div
            className="relative bg-center bg-cover h-[500px] group bg-no-repeat transition-all duration-500 ease-in-out flex justify-center rounded-md cursor-pointer"
            style={{
        ...
        >
            {/* Overlay */}
            <div className="absolute inset-0 transition-all duration-300 group-hover:bg-primary group-hover:bg-opacity-35 rounded-md"></div>
            ...
            <div className='z-10 absolute p-3 bottom-0'>
                <div className='bg-white p-4 group-hover:-translate-y-44  transition-all duration-500 ease-in-out rounded-md'>
                    <div>
