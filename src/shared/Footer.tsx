...
// Define a type for NavLink props
...
const NavLink: React.FC<NavLinkProps> = ({ link, label }) => (
  <li>
    <Link
      to={link}
      className="mb-2 inline-block text-base leading-loose text-[#a1a6ab] hover:text-secondary"
    >
      {label}
    </Link>
  </li>
...
// Define a type for LinkGroup props
interface LinkGroupProps {
  header: string;
  children: React.ReactNode;
}

// Define the LinkGroup component
const LinkGroup: React.FC<LinkGroupProps> = ({ header, children }) => (
  <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
    <div className="mb-10 w-full">
      <h4 className="mb-9 text-lg font-semibold text-dark dark:text-white">{header}</h4>
      <ul>{children}</ul>
    </div>
  </div>
);
...
const Footer: React.FC = () => {
  return (
    <footer
      className="relative bg-cover bg-center text-white bg-no-repeat z-10 pb-10 pt-10 bg-[#1C2733] lg:pb-4 lg:pt-[110px]"
      ...
      <div className="container mx-auto md:px-10 px-5 md:text-start text-center">
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              <Link className="mb-10 inline-block max-w-[160px]" to="/">
                <div className="font-bold text-3xl md:text-4xl gap-3 flex items-center">
              ...
              <p className="flex md:justify-start justify-center items-center text-sm font-medium text-dark dark:text-[#a1a6ab]">
                <span className="mr-3 text-primary">
                  ...
                  >
                    <g>
                      <path
                        d="M15.1875 19.4688C14.3438 19.4688 13.375 19.25 12.3125 18.8438..."
                        fill="currentColor"
                      />
                    </g>
                  </svg>
